...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 640 537" }, props),
        React.createElement("image", { width: "640", height: "537", href: "/images/egg/logo.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 640 112" }, props),
        React.createElement("image", { width: "640", height: "112", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Container$4 = styled.div(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  flex: none;\n  padding: 8px 4px;\n  width: ", ";\n  background-color: ", ";\n  border-top: ", ";\n\n  ", " {\n    padding: 0;\n    overflow-x: hidden;\n  }\n"], ["\n  flex: none;\n  padding: 8px 4px;\n  width: ", ";\n  background-color: ", ";\n  border-top: ", ";\n\n  ", " {\n    padding: 0;\n    overflow-x: hidden;\n  }\n"])), function (_a) {
    var hideBorder = _a.hideBorder;
    return hideBorder ? "200px" : "100%";
}, function (_a) {
    var hideBorder = _a.hideBorder, theme = _a.theme;
    return hideBorder ? "none" : theme.nav.background;
}, function (_a) {
    var hideBorder = _a.hideBorder;
    return hideBorder ? "none" : "solid 2px rgba(133, 133, 133, 0.1)";
}, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, cakePriceUsd = _a.cakePriceUsd, priceLink = _a.priceLink, hideBorder = _a.hideBorder;
    if (!isPushed && !hideBorder) {
        return (React.createElement(Container$4, null,
            React.createElement(IconButton, { variant: "text", onClick: function () { return pushNav(true); } },
                React.createElement(Icon$l, null))));
    }
    return (React.createElement(Container$4, { hideBorder: true },
...
var UserBlock = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null, account ? (React.createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(NavWrapper, null,
                ...
                React.createElement(Flex, null,
                    React.createElement(PanelFooter, { hideBorder: true, isPushed: isPushed, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
...
var templateObject_1$J, templateObject_2$g, templateObject_3$8, templateObject_4$2, templateObject_5$1, templateObject_6;
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e9f1fd", background: "#1f2b46", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#0a0e17", input: "#483f3b", inputBorder: "#cccccc", primaryDark: "#278CC7", tertiary: "#2d2f37", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#278CC7", borderColor: "#524B63", card: "#121827", gradients: {
